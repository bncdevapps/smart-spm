                    ...
                    <div class="modal-content border-primary">
                        <div class="modal-header">
                            <h5 class="modal-title">
                                {{ $isRead ? 'Lihat SPM' : ($updateMode ? 'Perbaiki SPM' : 'Buat SPM') }}
                            </h5>
                        ...
                        <form wire:submit="{{ $updateMode ? 'draftUpdate' : 'draft' }}" enctype="multipart/form-data">
                            <div class="modal-body">
                                    ...
                                    <div class="card-body p-3">
                                        ...
                                        @if(!$showPpn && empty($pajak_lain_items))
                                            <div class="text-muted text-center py-2 fst-italic">
                                                Belum ada pajak yang ditambahkan. Klik <strong>+ Tambah PPN</strong> atau <strong>+ Tambah Pajak Lainnya</strong> di atas jika ada pajak.
                                            </div>
                                        @endif
                                    </div>
                                </div>
                                <div class="card mb-3 border-secondary">
                                    <div class="card-header d-flex justify-content-between align-items-center bg-light py-2">
                                        ...
                                        <div>
                                            <button type="button" wire:click="addPotonganItem" class="btn btn-sm btn-outline-warning text-dark">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-plus" width="18" height="18" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M12 5l0 14" /><path d="M5 12l14 0" /></svg>
                                                Tambah Potongan
                                            </button>
                                        </div>
                                    ...
                                    <div class="card-body p-3">
                                        @foreach($potongan_items as $index => $item)
                                            <div class="border rounded p-3 mb-3 bg-light-subtle" wire:key="potongan-item-{{ $index }}">
                                                <div class="d-flex justify-content-between align-items-center mb-2">
                                                    <strong class="text-warning text-dark">📌 Potongan #{{ $index + 1 }}</strong>
                                                    <button type="button" wire:click="removePotonganItem({{ $index }})" class="btn btn-sm btn-outline-danger" title="Hapus Potongan ini">
                                                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-trash" width="18" height="18" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M4 7l16 0" /><path d="M10 11l0 6" /><path d="M14 11l0 6" /><path d="M5 7l1 12a2 2 0 0 0 2 2h8a2 2 0 0 0 2 -2l1 -12" /><path d="M9 7v-3a1 1 0 0 1 1 -1h4a1 1 0 0 1 1 1v3" /></svg> Hapus
                                                    </button>
                                                </div>
                                                <div class="row">
                                        ...
                                        @if(empty($potongan_items))
                                            <div class="text-muted text-center py-2 fst-italic">
                                                Belum ada potongan yang ditambahkan. Klik <strong>+ Tambah Potongan</strong> di atas jika ada potongan.
                                            </div>
                                        @endif
                                    </div>
                                </div>
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group input-group-flat ">
                                            ...
                                            <input wire:model="jumlah_netto"
                                                type="text" readonly
                                                class="form-control ps-0 @error('jumlah_netto') is-invalid @enderror">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="mb-3">
                                            <label class="form-label">Keterangan Dokumen yang Diupload <span class="form-label-description text-muted">(Opsional)</span></label>
                            ...
                            <div class="modal-footer">
                                <div class="d-flex ms-auto align-items-center">
                                    <div wire:loading wire:target='draftUpdate' class="spinner-border me-2"></div>
                                    <div wire:loading wire:target='draft' class="spinner-border me-2"></div>

                                    <button type="button" wire:click="closeModal()" class="btn btn-secondary me-2">
                                        Batal
                                    </button>
                                    <button type="submit" class="btn btn-primary">
                                        ...
                                        {{ $updateMode ? 'Simpan Perubahan' : 'Simpan Draft' }}
                                    </button>
                                </div>
                            </div>
                            @endif
        ...
        <div class="col-12">
            <div class="card shadow-sm border-0 rounded-3">
                ...
                <div class="card-header bg-white py-3 border-bottom d-flex flex-wrap justify-content-between align-items-center gap-2">
                    <div>
                        <h3 class="card-title fw-bold text-dark m-0">Daftar Dokumen SPM</h3>
                        <p class="text-muted small m-0">Kelola draft, ajukan usulan, dan pantau proses verifikasi SPM Anda</p>
                    </div>
                        ...
                        <tbody>
                            ...
                            <tr wire:key="{{ $data->id }}" class="transition-all">
                                ...
                                <td class="text-center text-wrap" style="min-width: 180px;">
                                    ...
                                    @elseif ($data->status_ajukan === 'draft' || $data->status === 'draft')
                                    ...
                                    @else
                                        <span class="badge bg-secondary-lt text-secondary fw-bold px-2 py-1">
                                            {{ strtoupper($data->status_ajukan ?: $data->status) }}
                                        </span>
                                    @endif
                                </td>
                                <td class="text-end pe-4">
                                    <div class="btn-list flex-nowrap justify-content-end">
                                        @if ($data->status === 'draft' || $data->status_ajukan === 'perlu perbaikan')
                                            <button data-bs-toggle="tooltip" data-bs-placement="top" title="Usulkan SPM" wire:click="ajukanId('{{ $data->id }}')"
                                            ...
                                            <button data-bs-toggle="tooltip" data-bs-placement="top" title="Hapus SPM" wire:click="deleteId('{{ $data->id }}')"
                            ...
                            <tr>
                                <td colspan="8" class="text-center py-5">
                                    <div class="empty">
                                        ...
                                        <p class="empty-title fw-bold text-dark mb-1">Tidak ada dokumen SPM ditemukan</p>
                                        <p class="empty-subtitle text-muted small mb-0">Belum ada data SPM yang dibuat atau sesuai dengan kata kunci pencarian Anda.</p>
                                    </div>
                                </td>
                            </tr>
                            @endforelse
